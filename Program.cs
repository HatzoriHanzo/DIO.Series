...
namespace DIO.Series
{
    class Program
    {
		...
		{	
			Console.Write("Digite o id do filme: ");
			int indiceFilme = int.Parse(Console.ReadLine());
			var filme = repositorioFilme.RetornaPorId(indiceFilme).retornaTitulo();
			Console.Write($"Tem certeza que deseja remover o filme:{filme.ToUpper()}? Digite SIM ou NÃO para prosseguir:");
			 String Confirmacao = Console.ReadLine().ToUpper();
			 
			if (Confirmacao == "SIM".Trim())
			{
				repositorioFilme.Exclui(indiceFilme);
				Console.Write("Filme Removido com Sucesso !");
			}
			else {
				Console.Write("O Filme não foi removido por opção do usuário.");
			}
		}
